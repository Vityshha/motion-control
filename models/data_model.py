...
class DataModel(object):
    ...
    def change_settings(self, _alpha, _activity_alpha, _activity_threshold, _detection_threshold, _min_object_area):
        self._alpha = _alpha
    ...
    def get_model_settings(self):
        return self._alpha, self._activity_alpha, self._activity_threshold, self._detection_threshold, self._min_object_area
